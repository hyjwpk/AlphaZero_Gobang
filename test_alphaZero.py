...
from asyn_mcts_alphaZero import MCTSPlayer as AsyncMCTSPlayer
...
def test_mcts_speed(player_class, board_class, n_playout=1000, repeat=3):
    ...
    best_policy = PolicyValueNet(9, 9, model_file=model_file).policy_value_fn
    board = board_class(width=9, height=9, n_in_row=5)
    board.init_board()
    player = player_class(best_policy, n_playout=n_playout)
